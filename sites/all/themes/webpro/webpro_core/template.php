...
define('WEBPRO_FILE_NOT_FOUND', 404);

/**
 * Maintenance page preprocessing
 */
function webpro_core_preprocess_maintenance_page(&$vars) {
  if (class_exists('Database', FALSE)) {
    // set html vars (html.tpl.php is in maintenance-page.tpl.php)
    webpro_core_preprocess_html($vars);
    // set page vars
    webpro_core_preprocess_page($vars);
  }
}
 ...
 * Page preprocessing
 */
function webpro_core_preprocess_page(&$vars) {
 ...
 */
function webpro_core_preprocess_region(&$vars) {
  static $grid;
 ...
 * Block preprocessing
 */
function webpro_core_preprocess_block(&$vars) {
  ...
  // Set a default block width if not already set by Webpro Apply
 ...
 */
function webpro_core_preprocess_comment(&$vars) {
 ...
 */
function webpro_core_preprocess_search_result(&$vars) {
 ...
 */
function webpro_core_region__header($vars) {
  return $vars['content'];
}
...
function webpro_core_grid_block($vars) {
  $output = '';
  if ($vars['content']) {
    $id = $vars['id'];
 ...
 */
function webpro_core_theme_paths($theme) {
